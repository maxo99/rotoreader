...
class TeamData(SQLModel, table=True):
    ...
    team_color2: str | None = Field(default=None, description="Secondary team color (hex code)")
    team_color3: str | None = Field(default=None, description="Tertiary team color (hex code)")
    team_color4: str | None = Field(default=None, description="Quaternary team color (hex code)")

    # Logo and image URLs
    team_logo_wikipedia: str | None = Field(default=None, description="Wikipedia logo URL")
    ...
    team_conference_logo: str | None = Field(default=None, description="Conference logo URL")
    team_league_logo: str | None = Field(default=None, description="NFL league logo URL")
    team_logo_squared: str | None = Field(default=None, description="Squared team logo URL")
